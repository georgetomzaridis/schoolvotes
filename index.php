      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-5">Καλωσορίσατε στο σύστημα ηλεκτρονικής ψηφοφορίας <br>του 3ου ΓΕΛ Ευόσμου</h1>
          </div>
            <?php
                if($system_status == "system_ready"){
                    ?>
                    <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                        <form action="" method="POST">
                            <button type="submit" class="btn btn-block btn-lg btn-primary" name="votenow">Ψηφίστε</button>
                        </form>
                    </div>
                    <?php
                }else{
